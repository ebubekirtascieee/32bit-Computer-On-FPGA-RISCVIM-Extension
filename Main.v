...
assign PS2_DATA_DEBUG = PS2_DATA;
...
localparam C_ROUTE_R_TYPE      = 6'd29;
...
*/
// 2. One physical 66-bit multiplier
wire signed [65:0] full_mul_result = mul_op1 * mul_op2;
    ...
    if (!sys_rst_n) begin        
        ...
        case (state)
            ...
            C_EXEC_M_TYPE: begin
                ...
                case (funct3)
                    // --- MULTIPLICATIONS (Fast, uses DSP blocks) ---
                    3'b000: begin 
                        write_data <= full_mul_result[31:0];
                        write_enable <= 1;
                        state <= return_state;
                    end
                    3'b001, 3'b010, 3'b011 : begin
                        write_data <= full_mul_result[63:32];
                        write_enable <= 1;
                        state <= return_state;
                    end
                    
                    // --- DIVISIONS (Slow, uses IP Core, needs stalling) ---

                    3'b100, 3'b101, 3'b110, 3'b111: begin
                        div_wait_cnt <= 0;
                        state <= C_WAIT_DIVISION;
                    end
